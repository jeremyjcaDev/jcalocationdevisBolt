-- =====================================================
-- Installation des tables du module jca_locationdevis
-- =====================================================
-- Remplacez 'ps_' par votre préfixe de table si différent
-- =====================================================

-- Table: rental_configurations
CREATE TABLE IF NOT EXISTS `ps_jca_rental_configurations` (
...
CREATE TABLE IF NOT EXISTS `ps_jca_quote_settings` (
...
-- Table: quotes
CREATE TABLE IF NOT EXISTS `ps_jca_quotes` (
...
-- Table: quote_items
CREATE TABLE IF NOT EXISTS `ps_jca_quote_items` (
  ...
  CONSTRAINT `fk_quote_items_quote` FOREIGN KEY (`id_quote`) REFERENCES `ps_jca_quotes` (`id_quote`) ON DELETE CASCADE,
  CONSTRAINT `fk_quote_items_rental_config` FOREIGN KEY (`id_rental_configuration`) REFERENCES `ps_jca_rental_configurations` (`id_rental_configuration`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: product_rental_availability
CREATE TABLE IF NOT EXISTS `ps_jca_product_rental_availability` (
  ...
  CONSTRAINT `fk_product_rental_config` FOREIGN KEY (`id_rental_configuration`) REFERENCES `ps_jca_rental_configurations` (`id_rental_configuration`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: customers
CREATE TABLE IF NOT EXISTS `ps_jca_quote_customers` (
  ...
  KEY `idx_email` (`email`),
  KEY `idx_id_quote` (`id_quote`),
  CONSTRAINT `fk_quote_customer_quote` FOREIGN KEY (`id_quote`) REFERENCES `ps_jca_quotes` (`id_quote`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
